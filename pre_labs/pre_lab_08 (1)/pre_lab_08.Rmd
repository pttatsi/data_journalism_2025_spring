...
**Answer** Go to Baltimore county 911 calls, then mutate a new column called month to group all dates to its specific month, then pair this with the total number of calls per month using the summarise and count functions 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a grey box in a white box, no data plotted
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** I see a bar chart with months on the x-axis and call count on the y-axis
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** Its the same graph as the first one, only difference is the axis has been flipped using the reorder function inside the aesthetics function
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The axis is back to normal on the bar chart, instead the bars have been flipped from horizontal to vertical. This makes it a bit easier to compare estimates of different values. 
...
**Answer** The theme_minimal() function changed the graph's background color.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** The background color changed to theme economist blue 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** We added a title and caption to the graph. We also renamed the x and y axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** we created a new column for total calls for each date in our dataset 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** We put each date as a point on the line graph, because there's so many entries it looks like a really excited heart 
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** Its the same line graph but we have added a date for each call which overloads our x axis 
```{r}
glimpse(baltco_911_calls_by_date)
```
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer** we angled the text on the x-axis to a 45 degree angle so it reads better 
