...
**Answer** The output now has two variables, as opposed to one because we grouped by term and department. Go to umd courses, and then, group by term and department, and then summarise/count the number of classes per term, itemized by department, and then, arrange them by those variables. 
