...
separate(value, c("date", "title"), sep=":") #separate columns 

mutate(title=case_when)
```

```{r}
html_elements(xpath= "xpath") #use div to stop doubles, //div[contains(@class)]

as.data.frame()

headline != "" #removes columns with spaces
